...
module clientVM_Linux '../../modules/Microsoft.Compute/Ubuntu20/VirtualMachine.bicep' = {
  ...
  params: {
    ...
    virtualMachine_ScriptFileLocation: 'https://raw.githubusercontent.com/jimgodden/Azure_Networking_Labs/main/scripts/TDTestScripts'
    virtualMachine_ScriptFileName: 'client.sh'
    commandToExecute: './client.sh'
  }
}
